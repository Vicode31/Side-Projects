...
const MobLegend = () => {
  ...
  const columnWidth = 0.25; // 10px for the square + 1px for each border (left and right)
  const margin = 0.125; // The right margin of the square
